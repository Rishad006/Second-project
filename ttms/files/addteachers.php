        ...
        if (empty($_FILES['file']['tmp_name'])) {
            ...
            while (!feof($handle)) {
                ...
                period10 VARCHAR(30)
                    ...
                    $days = array('saturday','monday', 'tuesday', 'wednesday', 'thursday', 'friday');
                    for ($i = 0; $i < 6; $i++) {
                        $day = $days[$i];
        ...
        <div class="modal-body" id="EnterTeacher">
            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    ...
                    <div align="right" background-color="green">
                        <input  style="background: green; color: white"type="submit" class="btn btn-default" name="ADD" value="ADD">
                    </div>
                </form>
            </div>
        </div>
