    ...
    <div id="TT" style="background-color: #FFFFFF">
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                ...
                <tr>
        <td style="text-align:center; background:green; font-style:arial bkack; color: white">WEEKDAYS</td>
                <td style="text-align:center; background:green; font-style:arial bkack; color: white">9:00-9:50</td>
                <td style="text-align:center; background:green; font-style:arial bkack; color: white">9:50-10:40</td>
                <td style="text-align:center; background:green; font-style:arial bkack; color: white">10:40-11:30</td>
                <td style="text-align:center; background:green; font-style:arial bkack; color: white">11:30-12:20</td>
                <td style="text-align:center; background:green; font-style:arial bkack; color: white">12:20-1:10</td>
                <td style="text-align:center; background:green; font-style:arial bkack; color: white">1:10-2:00</td>
                <td style="text-align:center; background:green; font-style:arial bkack; color: white">2:00-2:50</td>
                <td style="text-align:center; background:green; font-style:arial bkack; color: white">2:50-3:40</td>
                <td style="text-align:center; background:green; font-style:arial bkack; color: white">3:40-4:30</td>
                <td style="text-align:center; background:green; font-style:arial bkack; color: white">4:30-5:20</td>
        </tr>
            <tr>
                <?php
                $table = null;
                ...
                if (isset($_POST['select_semester']) || isset($_POST['select_teacher']) || isset($_SESSION['loggedin_id'])) {
                    ...
                    while ($row = mysqli_fetch_assoc($q)) {
                        ...
                        echo "
                 <tr><td style=\"text-align:center; background:firebrick; color:white\">$days[$i]</td>
                 <td style=\"text-align:center; font-style:arial black; background: burlywood;\">{$row['period1']}</td>
                <td style=\"text-align:center; background: burlywood\">{$row['period2']}</td>
                <td style=\"text-align:center; background: burlywood\">{$row['period3']}</td>
                 <td style=\"text-align:center; background:burlywood\">{$row['period4']}</td>
                  <td style=\"text-align:center; background:burlywood\">{$row['period5']}</td>
                  <td style=\"text-align:center; background: burlywood\">{$row['period6']}</td>
                  <td style=\"text-align:center; background: burlywood\">{$row['period7']}</td>
                  <td style=\"text-align:center; background: burlywood\">{$row['period8']}</td>
                  <td style=\"text-align:center; background: burlywood\">{$row['period9']}</td>
                  <td style=\"text-align:center; background: burlywood\">{$row['period10']}</td>
                </tr>\n";
                    }

                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM, COMPUTER ENGINEERING DEPARTMENT";
