    ...
    document.addEventListener('DOMContentLoaded', function() {
        function deleteHandlers() {
            ...
            for (let i = 1; i < rows.length; i++) {
                ...
                let button = currentRow.getElementsByTagName("button")[0];
...
<div align="center">
    ...
    <table id="allotedclassroomstable">
        ...
        $q = mysqli_query(mysqli_connect("localhost", "root", "", "ttms"),
            "SELECT * FROM classrooms ");
        $courses = array('BSC In CSE 1st Year(I)', 'BSC In CSE 1st Year(II)', 'BSC In CSE 2nd Year(III)', 'BSC In CSE 2nd Year(IV)', 'BSC In CSE 3rd Year(V)', 'BSC In CSE 3rd Year(VI)', 'BSC In CSE 4th Year(VII)', 'BSC In CSE 4th Year(VIII)');
        while ($row = mysqli_fetch_assoc($q)) {
            if ($row['status'] == 0)
                continue;
