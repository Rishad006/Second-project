...
period7='" . $subjectslots[$i][$j][6] . "<br>" . $aliasslots[$i][$j][6][0] . ",
period8='" . $subjectslots[$i][$j][7] . "<br>" . $aliasslots[$i][$j][7][0] . ",
period9='" . $subjectslots[$i][$j][8] . "<br>" . $aliasslots[$i][$j][8][0] . ",
period10='" . $subjectslots[$i][$j][9] . "<br>" . $aliasslots[$i][$j][9][0] . ", " . $aliasslots[$i][$j][9][1] . ", " . $aliasslots[$i][$j][9][2] . "'
 WHERE day='" . $days[$j] . "' ";
